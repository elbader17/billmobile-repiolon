...
class Home extends React.Component {
  ...
  calculateTotalInvoice = () => {
    const filterInvoices = this.props.invoices.filter(
  ...
  componentWillMount() {
    this.props.listInvoice().then(() => this.setState({ loading: false }));
  }
  ...
  componentDidUpdate() {
    ...
    if (
      this.state.registerToken != null &&
      this.props.user.token_device === null
    ) {
  ...
  renderRecentCustomers = () => {
    ...
    return <ListRecentCustomer invoices={invoices} />;
  };
          ...
          <View style={style.textFacPeriodo}>
            <View style={style.inLine}>
              <Icon
                ...
                color={COLORS.blueLight}
                size={18}
                iconStyle={{ marginLeft: 15, marginRight: 5 }}
              />
